...
if ! [[ -d "$HOME/.oh-my-zsh/plugins/zsh-autosuggestions" ]]; then
    git clone --quiet https://github.com/zsh-users/zsh-autosuggestions "$HOME/.oh-my-zsh/plugins/zsh-autosuggestions"
...
if ! [[ -d "$HOME/.oh-my-zsh/plugins/zsh-syntax-highlighting" ]]; then
    git clone --quiet https://github.com/zsh-users/zsh-syntax-highlighting.git "$HOME/.oh-my-zsh/plugins/zsh-syntax-highlighting"
...
if ! [[ -d "$HOME/.oh-my-zsh/plugins/zsh-you-should-use" ]]; then
    git clone --quiet https://github.com/MichaelAquilina/zsh-you-should-use.git "$HOME/.oh-my-zsh/plugins/zsh-you-should-use"
